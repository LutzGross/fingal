...
from fingal import ERTInversionPseudoGauss
from fingal import readElectrodeLocations, readSurveyData, makeMaskForOuterSurface
from esys.finley import ReadMesh
import numpy as np


CONFIG="config-ERT-PseudoGauss"
TABFN="ERT-PseudoGauss.log"

import logging
from datetime import datetime

logger=logging.getLogger('ERT-PseudoGauss')
...
for w1, with_misfit in [(1., False), (0., True), (1.e6, True)]:
    print("w1 = ", w1)
    costf.setW1(w1)
    ...
    #for d in [[ppy * ppz, 0, 0], [ppy * ppz, 0, 0], [0, ppx * ppz, 0], [0, 0, ppy * ppx],
    #          [ppy * ppz, ppx * ppz, ppy * ppx]]:
    for d in [ [ ppy*ppz*ppx, 0 ,0,0],  [0, ppy*ppz,0,0] , [0, 0,ppx*ppz,0], [0, 0,0,ppy*ppx], [ppy*ppz*ppx, ppy*ppz,ppx*ppz,ppy*ppx]  ]:
