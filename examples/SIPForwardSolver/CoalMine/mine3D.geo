...
//... mesh sizes ...
RESFAC=0.5;
meshSizeRemoteCore = 15. * RESFAC;
meshSizeCore = 5. * RESFAC;
meshSizeCloseToSeam = 3 *RESFAC;
meshSizeSeam = 2.5/1.2 *RESFAC ;
meshSizeElectrodes = 2.5/400 * RESFAC;
meshSizePadding = 2*(241.06384326395346+PaddingX)/15 *RESFAC;
//... mine lay out
