...
RefinementFactor = %RFMFAC%;

WidthOuterBox=8000.;
ThicknessOuterBox=3500.;
MeshSizeOuterBox=ThicknessOuterBox/5 * RefinementFactor ;

WidthInnerBox=4500.;
ThicknessInnerBox=1500.;
MeshSizeInnerBox=ThicknessInnerBox/5 * RefinementFactor;


// electrodes
MeshSizeAtElectrodes = 20  * RefinementFactor;
// anomaly 1:
Anomaly1Xoffset=600.;
Anomaly1Yoffset=0;
...
Anomaly1LengthX=900.;
Anomaly1LengthY=900.;
Anomaly1MeshSize=Anomaly1LengthX/4  * RefinementFactor;
...
Anomaly2LengthX=900.;
Anomaly2LengthY=900.;
Anomaly2MeshSize=Anomaly2LengthX/4  * RefinementFactor;
...
Anomaly3LengthX=900.;
Anomaly3LengthY=900.;
Anomaly3MeshSize=Anomaly3LengthX/4  * RefinementFactor;
...
//electrodes
k=newp;
Point(k+1)={ 0.0, 0.0, 0.0, MeshSizeAtElectrodes};
Point{k+1} In Surface{102};
//Physical Point("S1")={k+1};
Coherence;
...
Physical Surface("top", 421) = {2, 102};
Physical Surface("faces", 422) = {4, 5, 1, 6, 3};
