...
meshSizeCore = 5.;
meshSizeCloseToSeam = 3.5;
meshSizeSeam = 3;
meshSizeElectrodes = 5/10;
...
Point(467) = {-230.0899094590568, -192.43059616046958, 0., meshSizeCore};
...
Point(488) = {-120.63432427705266, -192.43059616046958, 0., meshSizeCore};
...
Point(533) = {-200.93421152001247, -192.43059616046958, 0., meshSizeCore};
...
Point(537) = {-160.5343242760282, -192.43059616046958, 0., meshSizeCore};
...
Point(541) = {-155.33432427304797, -192.43059616046958, 0., meshSizeCore};
...
Point(559) = {-194.93432427401422, -192.43059616046958, 0., meshSizeCore};
...
Point(589) = {241.06384326395346, -192.43059616046958, 0, meshSizeCore};
Point(590) = {-115.23432427900843, -192.43059616046958, 0, meshSizeCore};
...
Point(1083) = {-120.63432427705266, -192.43059616046958, GalleryHeight, meshSizeCore};
...
Point(1128) = {-200.93421152001247, -192.43059616046958, GalleryHeight, meshSizeCore};
...
Point(1132) = {-160.5343242760282, -192.43059616046958, GalleryHeight, meshSizeCore};
...
Point(1136) = {-155.33432427304797, -192.43059616046958, GalleryHeight, meshSizeCore};
...
Point(1154) = {-194.93432427401422, -192.43059616046958, GalleryHeight, meshSizeCore};
...
Point(1185) = {-115.23432427900843, -192.43059616046958, GalleryHeight, meshSizeCore};
...
Point(1203) = {241.06384326395346, -192.43059616046958, -BaseDepth, meshSizeRemoteCore};
Point(1204) = {-230.0899094590568, -192.43059616046958, -BaseDepth, meshSizeRemoteCore};
...
Point(1207) = {241.06384326395346, -192.43059616046958, CoreHeight, meshSizeCore};
Point(1208) = {-230.0899094590568, -192.43059616046958, CoreHeight, meshSizeRemoteCore};
...
Point(1503) = {241.06384326395346+PaddingX, -192.43059616046958-PaddingY, -BaseDepth-PaddingZ, meshSizePadding };
Point(1504) = {-230.0899094590568-PaddingX, -192.43059616046958-PaddingY, -BaseDepth-PaddingZ, meshSizePadding };
...
Point(1507) = {241.06384326395346+PaddingX, -192.43059616046958-PaddingY, CoreHeight+PaddingZ, meshSizePadding };
Point(1508) = {-230.0899094590568-PaddingX, -192.43059616046958-PaddingY, CoreHeight+PaddingZ, meshSizePadding };//+
Line(440) = {1505, 1508};
//+
Line(441) = {1508, 1507};
//+
