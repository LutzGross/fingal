...
parser.add_argument('--rerror', '-r',  dest='rerror', action='store_true', default=False, help="resistence/electric field has error")
parser.add_argument('--eerror', '-e',  dest='eerror', action='store_true', default=False, help="chargeability has error")
...
"hasResistanceError" : args.rerror,
"hasEtaError" : args.eerror,
"alpha1" : 10.
}
