...
parser.add_argument('--coredepth', '-d',  dest='coredepth', type=int, default=33, help="core depth relative to core width around core in %% of electrode area size (default 25)")
...
parser.add_argument('--padding', '-p',  dest='padding', type=int, default=400, help="relative padding around core in %% of core edge length (default 200)")
